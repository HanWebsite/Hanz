...
function hashPassword(password) {
  ...
  // Fungsi untuk memverifikasi password yang diinput dengan password yang di-hash
  ...
  // Contoh penggunaan
  const storedPassword = hashPassword('Hannz'); // Menghasilkan hash dari password yang akan disimpan di database
  
  // Simulasi login
  const inputPassword = 'Hannz';
  const isPasswordCorrect = verifyPassword(inputPassword, storedPassword);
  
  if (isPasswordCorrect) {
    console.log('\x1b[32m%s\x1b[0m', '[@Hannz - Logs]');
    console.log('\x1b[32m%s\x1b[0m', '[@Succes - Login]');
  }
